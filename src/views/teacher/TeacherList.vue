<template>
    <div class="title-menu">
        ...
        <div>
            <CommonButton variant="primary" size="small">강사노출 순서조정</CommonButton>
        </div>
    </div>
    ...
    <!-- <div class="btn-align between">
        <div class="btn-box">
            <CommonButton variant="primary" size="small">실서버 에서 이미지 불러오기</CommonButton>
        </div>
    </div> -->
                    ...
                    <tr v-for="teacher in teacherList" :key="teacher.code">
                            ...
                            <table class="type-3 auto">
                                ...
                                <tbody>
                                    ...
                                    :key="detail.tcCname"
                                        ...
                                        <td>
                                            <select name="view" onchange="checkview('5610','Y',this)" class="select-basic">
                                        ...
                                        <td>
                                            <select name="view" onchange="checklevel('5610','N',this)" class="select-basic">
                        ...
                        <td>
                            <CommonButton
                                variant="primary"
                                size="small"
                                :to="{ path: '/teacher/teacher-modify' }"
                                >
                                수정
                            </CommonButton>
                        </td>
    ...
    <div class="btn-align between">
        <div class="btn-box">
            <CommonButton variant="primary" size="small">메인노출</CommonButton>
        </div>
        <div class="btn-box">
            <CommonButton
                variant="primary"
                size="small"
                :to="{ path: '/teacher/teacher-write' }"
                >
                강사등록
            </CommonButton>
        </div>
